...
This is a fork of [david-vct/ydotool-rebind](https://github.com/david-vct/ydotool-rebind), which originally supported French AZERTY only. This fork adds multi-layout support (German, Belgian, Italian, Spanish) and can select the right layout from your system configuration.
